...
export const metadata: Metadata = {
  ...
  description:
    'Vision Nectar Cookie Policy - Learn about our cookie usage and data collection practices.',
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-primary-600 max-w-3xl mx-auto">
              Information about how Vision Nectar uses cookies and similar
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              <div className="bg-primary-50 border-l-4 border-primary-500 p-6 rounded-lg mb-8">
                ...
                <p className="text-primary-700 text-lg">
                  <strong>
                    Vision Nectar currently does not use cookies on our website.
                  </strong>{' '}
                  We have designed our site to function without storing any
                  cookies on your device at this time.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4 text-primary-700">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    ...
                    performance by collecting usage data
                  </li>
                  <li>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4 text-primary-700">
                <p>
                  While we don't currently use cookies, we may implement them in
                  the future to enhance your experience on our website. If we do
                  decide to use cookies, we will:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>Update this Cookie Policy with detailed information</li>
                  <li>Notify you of any changes through our website</li>
                  <li>
                    Only use cookies that are necessary or beneficial to your
                    experience
                  </li>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-6 text-primary-700">
                ...
                <div className="bg-white border border-primary-200 rounded-lg p-6">
                  ...
                  <p>
                    These would be necessary for our website to function
                    properly, such as maintaining your session or remembering
                ...
                <div className="bg-white border border-primary-200 rounded-lg p-6">
                  ...
                  <p>
                    These would help us understand how visitors use our website,
                    which pages are most popular, and how we can improve the
                    user experience.
                  </p>
                </div>
                ...
                <div className="bg-white border border-primary-200 rounded-lg p-6">
                  ...
                  <p>
                    These would remember your choices and preferences to provide
                    a more personalized experience on return visits.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4 text-primary-700">
                <p>
                  Even though we don't currently use cookies, you can control
                  how cookies are handled by your browser. Most browsers allow
                  you to:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Block all cookies (though this may affect website
                    functionality)
                  </li>
                  <li>Set preferences for different types of cookies</li>
                </ul>
                <p>
                  To manage cookies, look for "Privacy" or "Cookie" settings in
                  your browser's preferences or settings menu.
                </p>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4 text-primary-700">
                <p>
                  While our website doesn't use cookies, some third-party
                  services we may integrate with in the future could set their
                  own cookies. These might include:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <p>
                  If we integrate such services, we will update this policy and
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4 text-primary-700">
                <p>
                  We will update this Cookie Policy if we begin using cookies or
                  if there are any changes to how we handle cookies. Any updates
