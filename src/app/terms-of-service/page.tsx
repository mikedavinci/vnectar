...
export const metadata: Metadata = {
  ...
  description:
    'Vision Nectar Terms of Service - Learn about the terms and conditions for using our AI automation services.',
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-primary-600 max-w-3xl mx-auto">
              These terms govern your use of Vision Nectar's AI automation
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4 text-primary-700">
                <p>
                  By accessing and using Vision Nectar's website and services,
                ...
                <p>
                  ...
                  website located at visionnectar.com and our AI automation
                  services.
                </p>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4 text-primary-700">
                <p>
                  Vision Nectar provides AI automation services including but
                  not limited to:
                </p>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4 text-primary-700">
                <p>
                  ...
                  Vision Nectar and its licensors. The service is protected by
                  copyright, trademark, and other laws.
                </p>
                <p>
                  You retain ownership of content you provide to us, but grant
                  us a license to use it in connection with providing our
                  services.
                </p>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4 text-primary-700">
                <p>
                  ...
                  guarantee uninterrupted access to our services. We may:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    Perform scheduled maintenance that may temporarily affect
                    service
                  </li>
                  <li>
                    Experience unexpected downtime due to technical issues
                  </li>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4 text-primary-700">
                <p>
                  In no event shall Vision Nectar, nor its directors, employees,
